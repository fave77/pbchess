...
class EditProfilePopup extends Component {
  ...
  componentDidMount() {
    const {fullname, email, gender, country, avatar } = this.props;
  ...
  render() {
    ...
    const {alertSuccess, alertFailure, avatar, top, accessories, hairColor, facialHair, clothes,clothColor, eyes, eyebrow, mouth, skin} = this.state;

    return (
      <div className='edit-profile-popup'>
        <h3 className='edit-profile-popup__title'>Customize your Avatar</h3>
        <Form 
        ...
        >
          ...
          <img
            className="edit-profile-popup__user-img"
            src={`https://avataaars.io/?avatarStyle=Circle&topType=${top}&accessoriesType=${accessories}&hairColor=${hairColor}&facialHairType=${facialHair}&clotheType=${clothes}&eyeType=${eyes}&eyebrowType=${eyebrow}&mouthType=${mouth}&skinColor=${skin}&clotheColor=${clothColor}`}
            alt="your current profile"
            />

          {/* Avatar Properties */}
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_top">Hair</label>
          <Select
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_accessories">👓 Accessories</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_hairColor">💈 Hair Color</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_facialHair">Facial Hair Type</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_clothes">👔 Clothes</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_cloth_color"> Cloth Color</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_eyes">👁 Eyes</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_eyebrow">✏️ Eyebrow</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_mouth">👄 Mouth</label>
          <Select
            className='edit-profile-popup__input form-control' 
          ...
          <label className='edit-profile-popup__input-label-avatar' htmlFor="edit_mouth">🎨 Skin</label>
          <Select
            className='edit-profile-popup__input form-control' 
